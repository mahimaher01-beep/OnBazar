        ...
        <div className="container mx-auto px-2 md:px-4">
          ...
          <div className="relative flex h-14 md:h-20 items-center justify-between px-1 md:px-6 border-b border-muted/30">
            ...
            <div className="flex md:hidden items-center">
              ...
              {/* Logo (Centered in mobile, static in desktop) */}
              <div className="absolute left-1/2 -translate-x-1/2 md:static md:translate-x-0 flex items-center justify-center md:flex-initial">
                <Logo 
                  textClassName="text-lg md:text-2xl whitespace-nowrap" 
                  imageClassName="md:size-12"
