...
export async function generateMetadata(): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      title: {
        default: settings.metaTitle || settings.brandName || "OnBazar",
        template: `%s | ${settings.brandName || "OnBazar"}`,
      },
      ...
      appleWebApp: {
        ...
        title: settings.brandName || "OnBazar",
      },
      formatDetection: {
        telephone: false,
      },
      openGraph: {
        title: settings.metaTitle || settings.brandName || "OnBazar",
        description: settings.metaDescription || settings.brandName || "Your ultimate destination for quality products.",
        url: baseUrl,
        siteName: settings.brandName || "OnBazar",
        type: 'website',
      },
      twitter: {
