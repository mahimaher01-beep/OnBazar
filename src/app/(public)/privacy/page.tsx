...
export const metadata: Metadata = {
  title: 'Privacy Policy | OnBazar',
  description: 'Learn how OnBazar collects, uses, and protects your personal information.',
};
...
export default async function PrivacyPage() {
  ...
  const contactEmail = settings.contact?.email || "support@onbazar.com";
